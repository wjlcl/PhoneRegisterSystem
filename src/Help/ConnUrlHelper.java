...
public abstract class ConnUrlHelper {
	...
	public static String getPostHttpURLConnByUrl(String httpUrl, String params) {
		...
		try {
			...
			Log.e(DEBUG_TAG,
					"the getPostHttpURLConnByUrl methods  MalformedURLException erro");
		...
		if (url != null) {
			try {
				...
				// urlencoded编码过的form参数，下面我们可以看到我们对正文内容使用URLEncoder.encode
				// 进行编码
	...
	public static String getHttpClientConnByUrl(String url1) {
		...
		try {
			...
			Log.e(DEBUG_TAG,
					"the getHttpClientConnByUrl methods  ClientProtocolException erro");
		} catch (IOException e) {
			Log.e(DEBUG_TAG,
	...
	public static String getPostHttpClientConnByUrl(String httpUrl,
		...
		try {
			...
			Log.e(DEBUG_TAG,
					"the getPostHttpClientConnByUrl methods  ClientProtocolException erro");
		} catch (IOException e) {
			Log.e(DEBUG_TAG,
					"the getPostHttpClientConnByUrl methods  IOException erro");
		} catch (Exception e) {
			Log.e(DEBUG_TAG,
					"the getPostHttpClientConnByUrl methods  Exception erro");
		}
		return resultData;
	}
	 ...
	 * @param url1
	 *            请求的后台页面
	 * @return InputStream数据流
	 */
	public static InputStream getInputStreamByHttpURLConnByUrl(String url1) {
		URL url = null;
		...
		if (url != null) {
			try {
				...
				Log.e(DEBUG_TAG,
						"the getInputStreamByHttpURLConnByUrl methods  IOException erro");
			}
		} else {
			Log.e(DEBUG_TAG,
					"the getInputStreamByHttpURLConnByUrl methods  not null erro");
		}
		return inputStream;
	}
	 ...
	 * @return 返回的数据流
	 */
	public static InputStream getPostInputStreamByHttpURLConnByUrl(
			String httpUrl, String params) {
		// 获得的数据
		InputStream inputStream = null;
		URL url = null;
		try {
		...
		if (url != null) {
			try {
				...
				Log.e(DEBUG_TAG,
						"the getPostInputStreamByHttpURLConnByUrl methods  IOException erro");
			}
		} else {
			Log.e(DEBUG_TAG,
					"the getPostInputStreamByHttpURLConnByUrl methods  not null erro");
		}
		return inputStream;
	}
